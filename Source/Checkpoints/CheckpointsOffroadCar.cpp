...
#include "CheckpointsOffroadCar.h"
#include "CheckpointsOffroadWheelFront.h"
#include "CheckpointsOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

ACheckpointsOffroadCar::ACheckpointsOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCheckpointsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCheckpointsOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCheckpointsOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCheckpointsOffroadWheelRear::StaticClass();
