...
#include "CheckpointsSportsCar.h"
#include "CheckpointsSportsWheelFront.h"
#include "CheckpointsSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

ACheckpointsSportsCar::ACheckpointsSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UCheckpointsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UCheckpointsSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UCheckpointsSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UCheckpointsSportsWheelRear::StaticClass();
